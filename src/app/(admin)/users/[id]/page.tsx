  ...
  if (!user) {
    return (
      <div className="text-center py-20 text-gray-400">
        Usuario no encontrado. <Link href="/users" className="text-[#6C63FF] hover:underline">Volver</Link>
      </div>
    );
  }
